...
public class PropertiesUtil {
     ...
     * Properties配置文件容器
     */
    private static Map<String, Properties> proContainer = new ConcurrentHashMap<String, Properties>();
    ...
    public final static void native2asiiProperties(String originalProperties, String propertiesName) {
        ...
        String path = FileUtil.getAbsolutePath(originalProperties);
        ...
        for (Map.Entry<Object, Object> entry : properties.entrySet()) {
            ...
            content.append(key);
            content.append("=");
            content.append(StringUtil.string2Unicode(val, "UTF-8"));
            // content.append(val);
            content.append("\n");
        }
