...
public class ArrayUtil {
     ...
     * @param <T>
     * @param <T>
     * @param array               待截取的目标数组
     * @param startIndexInclusive 截取起始索引，包含起始索引(从零开始计算)
     * @param endIndexExclusive   截取结束索引，但不包含结束索引(从零开始计算)
     * @return
     */
     ...
     *
     * @param array                 原始数组
     * @param newArrayComponentType 新数组类型
     * @param N                     数组长度扩容大小
     * @return
     */
